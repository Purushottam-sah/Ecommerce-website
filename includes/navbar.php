<div class="wrapper">
    ...
    $displaylogo = "SELECT * FROM logo_db ORDER BY logo_created_at Desc LIMIT 1";
    $displaylogo_query = mysqli_query($conn, $displaylogo);
    ...
    ?>
        ...
        <a class="navbar-brand" href="home.php">
            <div class="header-logo">
               <?php 
                 if($displaylogo_query -> num_rows > 0){
                    while($row = $displaylogo_query -> fetch_assoc()){
                        ?>
                         <img src="admin/process/upload/logo/<?= $row['logo_img']?>" alt="logo" width="120">
                        <?php
